$(document).ready(function() {
    ...
    if (1 === $(".material-design-hamburger__icon").length && document.querySelector(".material-design-hamburger__icon").addEventListener("click", function() {
        ...
        }), $(document).keyup(function(e) { 27 == e.keyCode && ($(".search-results").fadeOut(300), $(".search input#search").blur()) }), $(".search input#search").focus(function() { 0 != $.trim($(".search input#search").val()).length && $(".search-results").fadeIn(300) }), $(".search input#search").keypress(function() { $(".search-results").fadeIn(300) }), $(".search-result-container").fadeOut();
        var t = function() { var e = 0; return function(a, t) { clearTimeout(e), e = setTimeout(a, t) } }();
